...
})({"aN7pz":[function(require,module,exports) {
...
pane.addMonitor(PARAMS, "scale", {
    label: "Scale H %"
});
pane.addMonitor(PARAMS, "arc", {
    label: "Arc %"
});
pane.addMonitor(PARAMS, "angle", {
    label: "Angle ˚"
});
const containerEl = document.getElementById("container");
(0, _gl.setup)(containerEl);
(0, _gl.draw)(PARAMS);
...
},{"tweakpane":"cvybH","./gl":"jTgm9"}],"cvybH":[function(require,module,exports) {
...
},{}],"jTgm9":[function(require,module,exports) {
...
const setup = (el)=>{
  ...
  void main() {
    ...
    if (!gl.getProgramParameter(shaderProgram, gl.LINK_STATUS)) throw Error(`Unable to initialize the shader program: ${gl.getProgramInfoLog(shaderProgram)}`);
    for (const name of [
        "iResolution"
    ].concat(floatUniforms))uniforms[name] = {
...
function loadShader(gl, type, source) {
    ...
    if (!gl.getShaderParameter(shader, gl.COMPILE_STATUS)) throw Error(`An error occurred compiling the shaders: ${gl.getShaderInfoLog(shader)}`);
    return shader;
}
const resize = ()=>{
...
const draw = (params)=>{
    ...
    params.angle = angle;
    if (abort) return;
    for (const name of floatUniforms)gl.uniform1f(u[name].location, u[name].value);
    gl.uniform2fv(uniforms.iResolution.location, [
        cv.width,
        cv.height
    ]);
...
},{}]},["aN7pz","gLLPy"], "gLLPy", "parcelRequire4aa4")

//# sourceMappingURL=main.7a386bb5.js.map
